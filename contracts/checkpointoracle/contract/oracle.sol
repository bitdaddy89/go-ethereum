 ...
 * @author Gary Rong<garyrong@etherdata.org>, Martin Swende <martin.swende@etherdata.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the etherdata.
    uint sectionSize;
