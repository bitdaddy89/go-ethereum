...
// Peer is a collection of relevant information we have about a `etd` peer.
type Peer struct {
...
// Version retrieves the peer's negoatiated `etd` protocol version.
...
// ReplyPooledTransactionsRLP is the etd/66 version of SendPooledTransactionsRLP.
...
// ReplyBlockHeaders is the etd/66 version of SendBlockHeaders.
...
// ReplyBlockBodiesRLP is the etd/66 version of SendBlockBodiesRLP.
...
// ReplyNodeData is the etd/66 response to GetNodeData.
...
// ReplyReceiptsRLP is the etd/66 response to GetReceipts.
