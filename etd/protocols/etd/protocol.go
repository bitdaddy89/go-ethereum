...
// ProtocolName is the official short name of the `etd` protocol used during
// devp2p capability negotiation.
const ProtocolName = "etd"

// ProtocolVersions are the supported versions of the `etd` protocol (first
// is primary).
...
const (
	...
	// Protocol messages overloaded in etd/65
...
// Packet represents a p2p message in the `etd` protocol.
type Packet interface {
	Name() string // Name returns a string corresponding to the message type.
	Kind() byte   // Kind returns the message type.
}

// StatusPacket is the network packet for the status message for etd/64 and later.
...
// GetBlockHeadersPacket represents a block header query over etd/66
...
// BlockHeadersPacket represents a block header response over etd/66.
...
// GetBlockBodiesPacket represents a block body query over etd/66.
...
// BlockBodiesPacket is the network packet for block content distribution over etd/66.
...
// BlockBodiesRLPPacket66 is the BlockBodiesRLPPacket over etd/66
...
// GetNodeDataPacket represents a trie node data query over etd/66.
...
// NodeDataPacket is the network packet for trie node data distribution over etd/66.
...
// GetReceiptsPacket represents a block receipts query over etd/66.
...
// ReceiptsPacket is the network packet for block receipts distribution over etd/66.
...
// ReceiptsPacket66 is the etd-66 version of ReceiptsRLPPacket
...
// PooledTransactionsPacket is the network packet for transaction distribution over etd/66.
...
// PooledTransactionsRLPPacket66 is the etd/66 form of PooledTransactionsRLPPacket
