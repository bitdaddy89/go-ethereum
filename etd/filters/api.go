...
// information related to the Etherdata protocol such als blocks, transactions and logs.
...
// `etd_getFilterChanges` polling method that is also used for log filters.
//
// https://etd.wiki/json-rpc/API#etd_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with etd_getFilterChanges.
//
// https://etd.wiki/json-rpc/API#etd_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(etherdata.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as etherdata.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria etherdata.FilterQuery
...
//
// https://etd.wiki/json-rpc/API#etd_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(etherdata.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
...
//
// https://etd.wiki/json-rpc/API#etd_getlogs
...
//
// https://etd.wiki/json-rpc/API#etd_uninstallfilter
...
//
// https://etd.wiki/json-rpc/API#etd_getfilterlogs
...
//
// https://etd.wiki/json-rpc/API#etd_getfilterchanges
