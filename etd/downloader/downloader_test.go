...
import (
	...
	"github.com/crypyto-panel/go-etherdata"
	"github.com/crypyto-panel/go-etherdata/common"
	"github.com/crypyto-panel/go-etherdata/core/rawdb"
	"github.com/crypyto-panel/go-etherdata/core/state/snapshot"
...
type downloadTester struct {
	...
	stateDb etddb.Database // Database used by the tester for syncing from peers
	peerDb  etddb.Database // Database of the peers containing all data
...
func TestCanonicalSynchronisation65Full(t *testing.T)  { testCanonSync(t, etd.ETD65, FullSync) }
func TestCanonicalSynchronisation65Fast(t *testing.T)  { testCanonSync(t, etd.ETD65, FastSync) }
func TestCanonicalSynchronisation65Light(t *testing.T) { testCanonSync(t, etd.ETD65, LightSync) }

func TestCanonicalSynchronisation66Full(t *testing.T)  { testCanonSync(t, etd.ETD66, FullSync) }
func TestCanonicalSynchronisation66Fast(t *testing.T)  { testCanonSync(t, etd.ETD66, FastSync) }
func TestCanonicalSynchronisation66Light(t *testing.T) { testCanonSync(t, etd.ETD66, LightSync) }
...
func TestThrottling65Full(t *testing.T) { testThrottling(t, etd.ETD65, FullSync) }
func TestThrottling65Fast(t *testing.T) { testThrottling(t, etd.ETD65, FastSync) }

func TestThrottling66Full(t *testing.T) { testThrottling(t, etd.ETD66, FullSync) }
func TestThrottling66Fast(t *testing.T) { testThrottling(t, etd.ETD66, FastSync) }
...
func TestForkedSync65Full(t *testing.T)  { testForkedSync(t, etd.ETD65, FullSync) }
func TestForkedSync65Fast(t *testing.T)  { testForkedSync(t, etd.ETD65, FastSync) }
func TestForkedSync65Light(t *testing.T) { testForkedSync(t, etd.ETD65, LightSync) }

func TestForkedSync66Full(t *testing.T)  { testForkedSync(t, etd.ETD66, FullSync) }
func TestForkedSync66Fast(t *testing.T)  { testForkedSync(t, etd.ETD66, FastSync) }
func TestForkedSync66Light(t *testing.T) { testForkedSync(t, etd.ETD66, LightSync) }
...
func TestHeavyForkedSync65Full(t *testing.T)  { testHeavyForkedSync(t, etd.ETD65, FullSync) }
func TestHeavyForkedSync65Fast(t *testing.T)  { testHeavyForkedSync(t, etd.ETD65, FastSync) }
func TestHeavyForkedSync65Light(t *testing.T) { testHeavyForkedSync(t, etd.ETD65, LightSync) }

func TestHeavyForkedSync66Full(t *testing.T)  { testHeavyForkedSync(t, etd.ETD66, FullSync) }
func TestHeavyForkedSync66Fast(t *testing.T)  { testHeavyForkedSync(t, etd.ETD66, FastSync) }
func TestHeavyForkedSync66Light(t *testing.T) { testHeavyForkedSync(t, etd.ETD66, LightSync) }
...
// long dead chains.
func TestBoundedForkedSync65Full(t *testing.T)  { testBoundedForkedSync(t, etd.ETD65, FullSync) }
func TestBoundedForkedSync65Fast(t *testing.T)  { testBoundedForkedSync(t, etd.ETD65, FastSync) }
func TestBoundedForkedSync65Light(t *testing.T) { testBoundedForkedSync(t, etd.ETD65, LightSync) }

func TestBoundedForkedSync66Full(t *testing.T)  { testBoundedForkedSync(t, etd.ETD66, FullSync) }
func TestBoundedForkedSync66Fast(t *testing.T)  { testBoundedForkedSync(t, etd.ETD66, FastSync) }
func TestBoundedForkedSync66Light(t *testing.T) { testBoundedForkedSync(t, etd.ETD66, LightSync) }
...
func TestBoundedHeavyForkedSync65Full(t *testing.T) {
	testBoundedHeavyForkedSync(t, etd.ETD65, FullSync)
}
func TestBoundedHeavyForkedSync65Fast(t *testing.T) {
	testBoundedHeavyForkedSync(t, etd.ETD65, FastSync)
}
func TestBoundedHeavyForkedSync65Light(t *testing.T) {
	testBoundedHeavyForkedSync(t, etd.ETD65, LightSync)
}

func TestBoundedHeavyForkedSync66Full(t *testing.T) {
	testBoundedHeavyForkedSync(t, etd.ETD66, FullSync)
}
func TestBoundedHeavyForkedSync66Fast(t *testing.T) {
	testBoundedHeavyForkedSync(t, etd.ETD66, FastSync)
}
func TestBoundedHeavyForkedSync66Light(t *testing.T) {
	testBoundedHeavyForkedSync(t, etd.ETD66, LightSync)
}
...
func TestCancel65Full(t *testing.T)  { testCancel(t, etd.ETD65, FullSync) }
func TestCancel65Fast(t *testing.T)  { testCancel(t, etd.ETD65, FastSync) }
func TestCancel65Light(t *testing.T) { testCancel(t, etd.ETD65, LightSync) }

func TestCancel66Full(t *testing.T)  { testCancel(t, etd.ETD66, FullSync) }
func TestCancel66Fast(t *testing.T)  { testCancel(t, etd.ETD66, FastSync) }
func TestCancel66Light(t *testing.T) { testCancel(t, etd.ETD66, LightSync) }
...
func TestMultiSynchronisation65Full(t *testing.T)  { testMultiSynchronisation(t, etd.ETD65, FullSync) }
func TestMultiSynchronisation65Fast(t *testing.T)  { testMultiSynchronisation(t, etd.ETD65, FastSync) }
func TestMultiSynchronisation65Light(t *testing.T) { testMultiSynchronisation(t, etd.ETD65, LightSync) }

func TestMultiSynchronisation66Full(t *testing.T)  { testMultiSynchronisation(t, etd.ETD66, FullSync) }
func TestMultiSynchronisation66Fast(t *testing.T)  { testMultiSynchronisation(t, etd.ETD66, FastSync) }
func TestMultiSynchronisation66Light(t *testing.T) { testMultiSynchronisation(t, etd.ETD66, LightSync) }
...
func TestMultiProtoSynchronisation65Full(t *testing.T)  { testMultiProtoSync(t, etd.ETD65, FullSync) }
func TestMultiProtoSynchronisation65Fast(t *testing.T)  { testMultiProtoSync(t, etd.ETD65, FastSync) }
func TestMultiProtoSynchronisation65Light(t *testing.T) { testMultiProtoSync(t, etd.ETD65, LightSync) }

func TestMultiProtoSynchronisation66Full(t *testing.T)  { testMultiProtoSync(t, etd.ETD66, FullSync) }
func TestMultiProtoSynchronisation66Fast(t *testing.T)  { testMultiProtoSync(t, etd.ETD66, FastSync) }
func TestMultiProtoSynchronisation66Light(t *testing.T) { testMultiProtoSync(t, etd.ETD66, LightSync) }
...
func testMultiProtoSync(t *testing.T, protocol uint, mode SyncMode) {
	...
	tester.newPeer("peer 65", etd.ETD65, chain)
	tester.newPeer("peer 66", etd.ETD66, chain)
...
func TestEmptyShortCircuit65Full(t *testing.T)  { testEmptyShortCircuit(t, etd.ETD65, FullSync) }
func TestEmptyShortCircuit65Fast(t *testing.T)  { testEmptyShortCircuit(t, etd.ETD65, FastSync) }
func TestEmptyShortCircuit65Light(t *testing.T) { testEmptyShortCircuit(t, etd.ETD65, LightSync) }

func TestEmptyShortCircuit66Full(t *testing.T)  { testEmptyShortCircuit(t, etd.ETD66, FullSync) }
func TestEmptyShortCircuit66Fast(t *testing.T)  { testEmptyShortCircuit(t, etd.ETD66, FastSync) }
func TestEmptyShortCircuit66Light(t *testing.T) { testEmptyShortCircuit(t, etd.ETD66, LightSync) }
...
func TestMissingHeaderAttack65Full(t *testing.T)  { testMissingHeaderAttack(t, etd.ETD65, FullSync) }
func TestMissingHeaderAttack65Fast(t *testing.T)  { testMissingHeaderAttack(t, etd.ETD65, FastSync) }
func TestMissingHeaderAttack65Light(t *testing.T) { testMissingHeaderAttack(t, etd.ETD65, LightSync) }

func TestMissingHeaderAttack66Full(t *testing.T)  { testMissingHeaderAttack(t, etd.ETD66, FullSync) }
func TestMissingHeaderAttack66Fast(t *testing.T)  { testMissingHeaderAttack(t, etd.ETD66, FastSync) }
func TestMissingHeaderAttack66Light(t *testing.T) { testMissingHeaderAttack(t, etd.ETD66, LightSync) }
...
func TestShiftedHeaderAttack65Full(t *testing.T)  { testShiftedHeaderAttack(t, etd.ETD65, FullSync) }
func TestShiftedHeaderAttack65Fast(t *testing.T)  { testShiftedHeaderAttack(t, etd.ETD65, FastSync) }
func TestShiftedHeaderAttack65Light(t *testing.T) { testShiftedHeaderAttack(t, etd.ETD65, LightSync) }

func TestShiftedHeaderAttack66Full(t *testing.T)  { testShiftedHeaderAttack(t, etd.ETD66, FullSync) }
func TestShiftedHeaderAttack66Fast(t *testing.T)  { testShiftedHeaderAttack(t, etd.ETD66, FastSync) }
func TestShiftedHeaderAttack66Light(t *testing.T) { testShiftedHeaderAttack(t, etd.ETD66, LightSync) }
...
func TestInvalidHeaderRollback65Fast(t *testing.T) { testInvalidHeaderRollback(t, etd.ETD65, FastSync) }
func TestInvalidHeaderRollback66Fast(t *testing.T) { testInvalidHeaderRollback(t, etd.ETD66, FastSync) }
...
func TestHighTDStarvationAttack65Full(t *testing.T) {
	testHighTDStarvationAttack(t, etd.ETD65, FullSync)
}
func TestHighTDStarvationAttack65Fast(t *testing.T) {
	testHighTDStarvationAttack(t, etd.ETD65, FastSync)
}
func TestHighTDStarvationAttack65Light(t *testing.T) {
	testHighTDStarvationAttack(t, etd.ETD65, LightSync)
}

func TestHighTDStarvationAttack66Full(t *testing.T) {
	testHighTDStarvationAttack(t, etd.ETD66, FullSync)
}
func TestHighTDStarvationAttack66Fast(t *testing.T) {
	testHighTDStarvationAttack(t, etd.ETD66, FastSync)
}
func TestHighTDStarvationAttack66Light(t *testing.T) {
	testHighTDStarvationAttack(t, etd.ETD66, LightSync)
}
...
func TestBlockHeaderAttackerDropping65(t *testing.T) { testBlockHeaderAttackerDropping(t, etd.ETD65) }
func TestBlockHeaderAttackerDropping66(t *testing.T) { testBlockHeaderAttackerDropping(t, etd.ETD66) }
...
func TestSyncProgress65Full(t *testing.T)  { testSyncProgress(t, etd.ETD65, FullSync) }
func TestSyncProgress65Fast(t *testing.T)  { testSyncProgress(t, etd.ETD65, FastSync) }
func TestSyncProgress65Light(t *testing.T) { testSyncProgress(t, etd.ETD65, LightSync) }

func TestSyncProgress66Full(t *testing.T)  { testSyncProgress(t, etd.ETD66, FullSync) }
func TestSyncProgress66Fast(t *testing.T)  { testSyncProgress(t, etd.ETD66, FastSync) }
func TestSyncProgress66Light(t *testing.T) { testSyncProgress(t, etd.ETD66, LightSync) }
...
func testSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", etherdata.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", etherdata.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", etherdata.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", etherdata.SyncProgress{
		StartingBlock: uint64(chain.len()/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want etherdata.SyncProgress) {
	// Mark this method as a helper to report errors at callsite, not in here
	t.Helper()
...
// revertal).
func TestForkedSyncProgress65Full(t *testing.T)  { testForkedSyncProgress(t, etd.ETD65, FullSync) }
func TestForkedSyncProgress65Fast(t *testing.T)  { testForkedSyncProgress(t, etd.ETD65, FastSync) }
func TestForkedSyncProgress65Light(t *testing.T) { testForkedSyncProgress(t, etd.ETD65, LightSync) }

func TestForkedSyncProgress66Full(t *testing.T)  { testForkedSyncProgress(t, etd.ETD66, FullSync) }
func TestForkedSyncProgress66Fast(t *testing.T)  { testForkedSyncProgress(t, etd.ETD66, FastSync) }
func TestForkedSyncProgress66Light(t *testing.T) { testForkedSyncProgress(t, etd.ETD66, LightSync) }
...
func testForkedSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", etherdata.SyncProgress{
...
func TestFailedSyncProgress65Full(t *testing.T)  { testFailedSyncProgress(t, etd.ETD65, FullSync) }
func TestFailedSyncProgress65Fast(t *testing.T)  { testFailedSyncProgress(t, etd.ETD65, FastSync) }
func TestFailedSyncProgress65Light(t *testing.T) { testFailedSyncProgress(t, etd.ETD65, LightSync) }

func TestFailedSyncProgress66Full(t *testing.T)  { testFailedSyncProgress(t, etd.ETD66, FullSync) }
func TestFailedSyncProgress66Fast(t *testing.T)  { testFailedSyncProgress(t, etd.ETD66, FastSync) }
func TestFailedSyncProgress66Light(t *testing.T) { testFailedSyncProgress(t, etd.ETD66, LightSync) }
...
func TestFakedSyncProgress65Full(t *testing.T)  { testFakedSyncProgress(t, etd.ETD65, FullSync) }
func TestFakedSyncProgress65Fast(t *testing.T)  { testFakedSyncProgress(t, etd.ETD65, FastSync) }
func TestFakedSyncProgress65Light(t *testing.T) { testFakedSyncProgress(t, etd.ETD65, LightSync) }

func TestFakedSyncProgress66Full(t *testing.T)  { testFakedSyncProgress(t, etd.ETD66, FullSync) }
func TestFakedSyncProgress66Fast(t *testing.T)  { testFakedSyncProgress(t, etd.ETD66, FastSync) }
func TestFakedSyncProgress66Light(t *testing.T) { testFakedSyncProgress(t, etd.ETD66, LightSync) }
...
func TestDeliverHeadersHang65Full(t *testing.T)  { testDeliverHeadersHang(t, etd.ETD65, FullSync) }
func TestDeliverHeadersHang65Fast(t *testing.T)  { testDeliverHeadersHang(t, etd.ETD65, FastSync) }
func TestDeliverHeadersHang65Light(t *testing.T) { testDeliverHeadersHang(t, etd.ETD65, LightSync) }

func TestDeliverHeadersHang66Full(t *testing.T)  { testDeliverHeadersHang(t, etd.ETD66, FullSync) }
func TestDeliverHeadersHang66Fast(t *testing.T)  { testDeliverHeadersHang(t, etd.ETD66, FastSync) }
func TestDeliverHeadersHang66Light(t *testing.T) { testDeliverHeadersHang(t, etd.ETD66, LightSync) }
...
func TestCheckpointEnforcement65Full(t *testing.T) { testCheckpointEnforcement(t, etd.ETD65, FullSync) }
func TestCheckpointEnforcement65Fast(t *testing.T) { testCheckpointEnforcement(t, etd.ETD65, FastSync) }
func TestCheckpointEnforcement65Light(t *testing.T) {
	testCheckpointEnforcement(t, etd.ETD65, LightSync)
}

func TestCheckpointEnforcement66Full(t *testing.T) { testCheckpointEnforcement(t, etd.ETD66, FullSync) }
func TestCheckpointEnforcement66Fast(t *testing.T) { testCheckpointEnforcement(t, etd.ETD66, FastSync) }
func TestCheckpointEnforcement66Light(t *testing.T) {
	testCheckpointEnforcement(t, etd.ETD66, LightSync)
}
