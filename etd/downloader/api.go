...
// Syncing provides information when this nodes starts synchronising with the Etherdata network and when it's finished.
...
type SyncingResult struct {
	...
	Status  etherdata.SyncProgress `json:"status"`
}
