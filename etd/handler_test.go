...
// testHandler is a live implementation of the Etherdata protocol handler, just
...
func newTestHandlerWithBlocks(blocks int) *testHandler {
	...
	bs, _ := core.GenerateChain(params.TestChainConfig, chain.Genesis(), etdash.NewFaker(), db, blocks, nil)
