...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "getd.ipc", false, filepath.Join(os.TempDir(), "getd.ipc")},
		{"data", "getd.ipc", false, "data/getd.ipc"},
		{"data", "./getd.ipc", false, "./getd.ipc"},
		{"data", "/getd.ipc", false, "/getd.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "getd.ipc", true, `\\.\pipe\getd.ipc`},
		{"data", "getd.ipc", true, `\\.\pipe\getd.ipc`},
		{"data", `\\.\pipe\getd.ipc`, true, `\\.\pipe\getd.ipc`},
	}
