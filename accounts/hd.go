...
// the `coin_type` 60' (or 0x8000003C) to Etherdata.
//
// The root path for Etherdata is m/44'/60'/0'/0 according to the specification
// from https://github.com/crypyto-panel/go-etherdata/EIPs/issues/84, albeit it's not set in stone
