...
func (mc *mockCaller) CallContract(ctx context.Context, call etherdata.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call etherdata.CallMsg) ([]byte, error) {
...
func TestPassingBlockNumber(t *testing.T) {
	...
	bc.Call(&bind.CallOpts{BlockNumber: blockNumber}, nil, "sometding")
	...
	bc.Call(&bind.CallOpts{}, nil, "sometding")
	...
	bc.Call(&bind.CallOpts{BlockNumber: blockNumber, Pending: true}, nil, "sometding")
