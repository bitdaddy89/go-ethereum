...
// Package bind generates Etherdata contract Go bindings.
//
// Detailed usage document and tutorial available on the go-etherdata Wiki page:
// https://github.com/crypyto-panel/go-etherdata/wiki/Native-DApps:-Go-bindings-to-Etherdata-contracts
package bind
