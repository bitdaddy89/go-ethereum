...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/crypyto-panel/go-etherdata/pyetdsaletool

		pyetdsaletool generates the encryption key from password by
	...
	*/
	...
	etdPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(etdPriv)
