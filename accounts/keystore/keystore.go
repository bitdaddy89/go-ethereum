...
// See https://github.com/crypyto-panel/go-etherdata/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given Etherdata presale wallet and stores
