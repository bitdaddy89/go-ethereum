...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain etherdata.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to etherdata-type signature.
		signature[64] -= 27 // Transform V from Etherdata-legacy to 0/1
	}
