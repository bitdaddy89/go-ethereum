...
func New(stack *node.Node, backend etdapi.Backend, cors, vhosts []string) error {
	if backend == nil {
...
func newHandler(stack *node.Node, backend etdapi.Backend, cors, vhosts []string) error {
	q := Resolver{backend}
