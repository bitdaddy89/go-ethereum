...
// most of Etherdata's existence, so might as well go with it.
...
// An Etherdata node doesn't need hundreds of connections to operate correctly,
...
type Tracker struct {
	...
	// (eg. etd.getHeaders vs snap.getAccountRange).
