...
Please see [Releases](https://github.com/crypyto-panel/go-ethereum/releases). We recommend using the [most recently released version](https://github.com/crypyto-panel/go-ethereum/releases/latest).

## Audit reports

Audit reports are published in the `docs` folder: https://github.com/crypyto-panel/go-ethereum/tree/master/docs/audits 

| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `geth` | 20170425 | [pdf](https://github.com/crypyto-panel/go-ethereum/blob/master/docs/audits/2017-04-25_Geth-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/crypyto-panel/go-ethereum/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
