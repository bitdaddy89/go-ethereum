...
Please see [Releases](https://github.com/crypyto-panel/go-etherdata/releases). We recommend using the [most recently released version](https://github.com/crypyto-panel/go-etherdata/releases/latest).

## Audit reports

Audit reports are published in the `docs` folder: https://github.com/crypyto-panel/go-etherdata/tree/master/docs/audits 

| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `getd` | 20170425 | [pdf](https://github.com/crypyto-panel/go-etherdata/blob/master/docs/audits/2017-04-25_Getd-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/crypyto-panel/go-etherdata/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |

## Reporting a Vulnerability

**Please do not file a public ticket** mentioning the vulnerability.

To find out how to disclose a vulnerability in Etherdata visit [https://bounty.etherdata.org](https://bounty.etherdata.org) or email bounty@etherdata.org. Please read the [disclosure page](https://github.com/crypyto-panel/go-etherdata/security/advisories?state=published) for more information about publically disclosed security vulnerabilities.

Use the built-in `getd version-check` feature to check whether the software is affected by any known vulnerability. This command will fetch the latest [`vulnerabilities.json`](https://getd.etherdata.org/docs/vulnerabilities/vulnerabilities.json) file which contains known security vulnerabilities concerning `getd`, and cross-check the data against its own version number.
