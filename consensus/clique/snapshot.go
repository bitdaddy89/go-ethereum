...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db etddb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db etddb.Database) error {
