...
func (db *Database) NewBatch() etddb.Batch {
	return &batch{
		db: db.db,
		b:  new(leveldb.Batch),
	}
...
func (db *Database) NewIterator(prefix []byte, start []byte) etddb.Iterator {
...
func (b *batch) Replay(w etddb.KeyValueWriter) error {
	return b.b.Replay(&replayer{writer: w})
}

// replayer is a small wrapper to implement the correct replay methods.
type replayer struct {
	writer  etddb.KeyValueWriter
	failure error
}
