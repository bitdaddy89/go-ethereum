...
* The external method `account_signTypedData` implements [EIP-712](https://github.com/crypyto-panel/go-etherdata/EIPs/blob/master/EIPS/eip-712.md) and makes it possible to sign typed data.
...
makes the `accounts_signTransaction` identical to the old `etd_signTransaction`.
