...
* The external method `account_signTypedData` implements [EIP-712](https://github.com/crypyto-panel/go-ethereum/EIPs/blob/master/EIPS/eip-712.md) and makes it possible to sign typed data.
