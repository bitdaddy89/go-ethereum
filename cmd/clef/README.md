...
The signer will generate a new private key, encrypt it according to [web3 keystore spec](https://github.com/crypyto-panel/go-ethereum/wiki/wiki/Web3-Secret-Storage-Definition) and store it in the keystore directory.  
...
#### Arguments
  - content type [string]: type of signed data
     ...
     - `application/clique`: [clique](https://github.com/crypyto-panel/go-ethereum/EIPs/issues/225) headers
...
#### Sign data
   Signs a chunk of structured data conformant to [EIP-712](https://github.com/crypyto-panel/go-ethereum/EIPs/blob/master/EIPS/eip-712.md) and returns the calculated signature.
...
| Clef UI| https://github.com/crypyto-panel/go-ethereum/clef-ui| Golang/QT-based| :+1:| :+1:| :x:| :+1:| :+1:| :x: |  :+1: (approve tx only)|
