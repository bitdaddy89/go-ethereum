...
For more details on writing automatic rules, please see the [rules spec](https://github.com/crypyto-panel/go-ethereum/go-ethereum/blob/master/cmd/clef/rules.md).
