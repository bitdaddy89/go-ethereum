...
import (
	...
	math2 "github.com/crypyto-panel/go-ethereum/go-ethereum/common/math"
...
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	...
	// https://github.com/crypyto-panel/go-ethereum/EIPs/blob/master/EIPS/eip-608.md
	spec.Params.EIP150Transition = hexutil.Uint64(genesis.Config.EIP150Block.Uint64())

	// Spurious Dragon: 155, 160, 161, 170
	// https://github.com/crypyto-panel/go-ethereum/EIPs/blob/master/EIPS/eip-607.md
