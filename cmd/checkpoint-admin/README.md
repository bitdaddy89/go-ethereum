...
*For a more detailed introduction to checkpoint, please see the LES [spec](https://github.com/crypyto-panel/go-ethereum/devp2p/blob/master/caps/les.md).*
...
```shell
go get github.com/crypyto-panel/go-ethereum/go-ethereum/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/crypyto-panel/go-ethereum/go-ethereum/blob/master/params/config.go#L251).*
