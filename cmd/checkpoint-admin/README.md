...
```shell
go get github.com/crypyto-panel/go-ethereum/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/crypyto-panel/go-ethereum/blob/master/params/config.go#L251).*
