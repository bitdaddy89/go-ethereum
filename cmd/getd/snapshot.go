...
var (
	snapshotCommand = cli.Command{
		...
		Subcommands: []cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale etherdata state data based on the snapshot",
				ArgsUsage: "<root>",
				...
				Description: `
getd snapshot prune-state <state-root>
...
during the use of Getd, please also specify it here for correct deletion. Otherwise
...
`,
			},
			{
				...
				Description: `
getd snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Description: `
getd snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Description: `
getd snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'getd dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'getd dump', but uses the snapshots
