...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Etherdata presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    getd wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Etherdata presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	getd wallet [options] /path/to/my/presale.wallet
...
between etherdata nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    getd account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    getd account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another etherdata instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := getdConfig{Node: defaultNodeConfig()}
	// Load config file.
