...
// Package etherdata defines interfaces for interacting with Etherdata.
package etherdata
...
type FilterQuery struct {
	BlockHash *common.Hash     // used by etd_getLogs, return logs only from block with this hash
