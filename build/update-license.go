...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/crypyto-panel/go-etherdata/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-etherdata authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-etherdata Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-etherdata library"
	}
	return "the go-etherdata library"
}
