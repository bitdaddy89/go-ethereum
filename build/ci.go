...
import (
	...
	"github.com/crypyto-panel/go-ethereum/go-ethereum/crypto/signify"
	"github.com/crypyto-panel/go-ethereum/go-ethereum/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/crypyto-panel/go-ethereum/go-ethereum/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/crypyto-panel/go-ethereum/go-ethereum/mobile")
