...
const (
	...
	subscribeTimeout   = 5 * time.Second  // overall timeout etd_subscribe, rpc_modules calls
)
...
// EthSubscribe registers a subscripion under the "etd" namespace.
func (c *Client) EthSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "etd", channel, args...)
}
