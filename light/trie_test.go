...
func TestNodeIterator(t *testing.T) {
	...
	blockchain, _ := core.NewBlockChain(fulldb, nil, params.TestChainConfig, etdash.NewFullFaker(), vm.Config{}, nil, nil)
	gchain, _ := core.GenerateChain(params.TestChainConfig, genesis, etdash.NewFaker(), fulldb, 4, testChainGen)
