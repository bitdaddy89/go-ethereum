...
// It can be used for testing that restart Getd normally.
...
// It can be used for testing that restart Getd after the crash.
...
// Tests a Getd restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Getd was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Getd was crashed and restarts with a broken snapshot. In this case
...
// Tests a Getd was running with snapshot enabled. Then restarts without
...
// Tests the Getd was running with snapshot enabled and resetHead is applied.
...
// Tests the Getd was running with a complete snapshot and then imports a few
