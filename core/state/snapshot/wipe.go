...
func wipeSnapshot(db etddb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db etddb.KeyValueStore) error {
...
func wipeKeyRange(db etddb.KeyValueStore, kind string, prefix []byte, origin []byte, limit []byte, keylen int, meter metrics.Meter, report bool) error {
