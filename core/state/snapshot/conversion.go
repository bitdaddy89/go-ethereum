...
type (
	...
	trieGeneratorFn func(db etddb.KeyValueWriter, in chan (trieKV), out chan (common.Hash))

	// leafCallbackFn is the callback invoked at the leaves of the trie,
	// returns the subtrie root with the specified subtrie identifier.
	leafCallbackFn func(db etddb.KeyValueWriter, accountHash, codeHash common.Hash, stat *generateStats) (common.Hash, error)
)
...
func GenerateTrie(snaptree *Tree, root common.Hash, src etddb.Database, dst etddb.KeyValueWriter) error {
	...
	got, err := generateTrieRoot(dst, acctIt, common.Hash{}, stackTrieGenerate, func(dst etddb.KeyValueWriter, accountHash, codeHash common.Hash, stat *generateStats) (common.Hash, error) {
...
func generateTrieRoot(db etddb.KeyValueWriter, it Iterator, account common.Hash, generatorFn trieGeneratorFn, leafCallback leafCallbackFn, stats *generateStats, report bool) (common.Hash, error) {
	var (
...
func stackTrieGenerate(db etddb.KeyValueWriter, in chan trieKV, out chan common.Hash) {
