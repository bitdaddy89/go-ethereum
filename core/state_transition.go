...
import (
	...
	cmath "github.com/crypyto-panel/go-etherdata/common/math"
...
func (st *StateTransition) preCheck() error {
	...
	if st.evm.ChainConfig().IsLondon(st.evm.Context.BlockNumber) {
		// Skip the checks if gas fields are zero and baseFee was explicitly disabled (etd_call)
...
func (st *StateTransition) refundGas(refundQuotient uint64) {
	...
	// Return ETD for remaining gas, exchanged at the original rate.
