...
func NewTable(db etddb.Database, prefix string) etddb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) etddb.Iterator {
...
func (t *table) NewBatch() etddb.Batch {
...
func (b *tableBatch) Replay(w etddb.KeyValueWriter) error {
