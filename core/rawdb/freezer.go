...
//   reserving it for go-etherdata. This would also reduce the memory requirements
//   of Getd, and thus also GC overhead.
type freezer struct {
...
func (f *freezer) freeze(db etddb.KeyValueStore) {
	...
	for {
		...
		// Log sometding friendly for the user
		context := []interface{}{
