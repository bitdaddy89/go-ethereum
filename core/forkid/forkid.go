...
// Package forkid implements EIP-2124 (https://eips.etherdata.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the Etherdata fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Etherdata fork ID from an existing chain instance.
...
func newFilter(config *params.ChainConfig, genesis common.Hash, headfn func() uint64) Filter {
	...
	return func(id ID) error {
		...
		return nil // Sometding's very wrong, accept rather than reject
	}
}
