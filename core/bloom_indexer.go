...
// for the Etherdata header bloom filters, permitting blazing fast filtering.
type BloomIndexer struct {
	size    uint64               // section size to generate bloombits for
	db      etddb.Database       // database instance to write index data and metadata into
...
func NewBloomIndexer(db etddb.Database, size, confirms uint64) *ChainIndexer {
