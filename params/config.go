...
var (
	...
	// and accepted by the Etherdata core developers into the Ethash consensus.
	//
	...
	// and accepted by the Etherdata core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/crypyto-panel/go-etherdata/EIPs/issues/150)
	...
	Ethash *EthashConfig `json:"etdash,omitempty"`
...
// CheckConfigForkOrder checks that we don't "skip" any forks, getd isn't pluggable enough
